...
namespace EFCoreRelationshipsTutorial.Controllers
{
    ...
    public class CharacterController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<Character>>> Create(CreateCharacterDto request)
        {
            ...
            _context.Characters.Add(newCharcter);
            await _context.SaveChangesAsync();

            return await Get(newCharcter.UserId);
        }
        ...
        [HttpPost("skill")]
        public async Task<ActionResult<Skill>> AddCharacterSkill(AddCharacterSkillDto request)
        {
